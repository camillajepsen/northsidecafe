...
<div class="wrapper">
    ...
    <form method="POST" action="success_create_staff_memberships.php" class="ht-600 w-50">
        ...
        <div class="form-group">
            ...
            <input type="text" name="Contact number" placeholder="+60101231234" class="form-control <?php echo !$Contact_number_Err ?: 'is-invalid'; ?>" id="Contact number" required value="<?php echo $Contact_number; ?>"><br>
            <div id="validationServerFeedback" class="invalid-feedback">
